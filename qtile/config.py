...
groups.append(ScratchPad('scratchpad', [
    DropDown('term', 'alacritty', width=0.5, height=0.55, x=0.26, y=0.1, opacity=1, on_focus_lost_hide=True, warp_pointer=True),
    DropDown('nvim', 'alacritty -e nvim', width=0.5, height=0.55, x=0.26, y=0.1, opacity=1, on_focus_lost_hide=True),
    DropDown('ranger', 'alacritty -e ranger', width=0.5, height=0.55, x=0.26, y=0.1, opacity=1, on_focus_lost_hide=True),
